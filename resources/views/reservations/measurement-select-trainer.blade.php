...
<div class="container-fluid app-container">
    <div class="scrollable-content">
        ...
        <p class="page-subtitle"><strong>{{ \Carbon\Carbon::parse($selectedDate)->translatedFormat('d F Y, l') }}</strong> tarihi için bir eğitmen seçin.</p>
...
<div id="timeModal" class="modal">
    <div class="modal-content">
        ...
        <form action="{{ route('reservations.measurement.store') }}" method="POST">
            @csrf
            <input type="hidden" name="reservation_date" value="{{ $selectedDate }}">
            <input type="hidden" name="trainer_id" id="modal_trainer_id">

            <div class="mb-3">
                <label for="reservation_time" class="form-label">Uygun bir saat seçiniz:</label>
                <input type="time" name="reservation_time" id="reservation_time" class="form-control" required step="1800">
